...
| Service                      | State                                                     | Notes                                                                                                                                                                                                                                                                                                                                                       |
| ---------------------------- | --------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Neon (serverless PostgreSQL) | one project, `gremuchaya-hq-control-plane`, PostgreSQL 18 | Two databases. `neondb` holds the dev schema with migrations 0001-0006 applied (0007 and 0008 arrived with F6 and reach it on the next `pnpm --filter @gremuchaya/control-plane migrate`); `hq_scratch` is the admin entry point for the destructive opt-in suite, which creates and drops `hqtest_*` beside it.                                            |
