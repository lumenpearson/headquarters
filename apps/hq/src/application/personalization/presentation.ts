...
export const settingsReadElsewhere: Readonly<Record<string, string>> = {
  ...
  'keybinds.introOnLaunch':
    'Read by KeybindIntro, which offers or withholds the first-launch card.',
  'keybinds.hiddenCategories': 'Read by KeybindList, which drops the named groups.',
  ...
  'popups.longPressDelay': 'Read by the pointer-menu runtime, which holds a press that long.',
  'popups.fieldMenu': 'Read by the pointer-menu runtime, which yields a field to the browser.',
  'popups.drawerWidth': 'Read by Drawer, which puts the width on the drawer as a class.',
  'popups.drawerScrim': 'Read by Drawer, which puts the scrim on the drawer as a class.',
  'materials.defaultSort': 'Read by FilesScreen, which seeds the material sort from it.',
