...
- **Читайте определение модуля, прежде чем судить о его поведении.** Вывод по результатам
  поиска или по местам вызова уже трижды приводил в этом проекте к неверным заключениям.
  Соответствующие случаи описаны в `docs/plans/actual_plan.md`.
...
ИИ-ассистентов.** Формат проверяет хук `commit-msg`, и такие строки будут отклонены.
